...
public class WebTable_StepDefinitions {
    ...
    public void user_enters_below_credentials(Map<String, String> credentials) {
       ...
       // System.out.println("credentials.get(\"password\") = " + credentials.get("password"));
        ...
        //webTableLoginPage.LoginButton.click(); YADA SOYLE YAPARIZ:

        //we can call our login utility method and pass value from map, click gerek yok, cunku utility nin icinde var
